...
for line in $( ls -1 /home/users/djambulingam/dhana/isbsequencing/epilepsy_lcsb/sequence/ ); do
    ls -1 /home/users/djambulingam/dhana/isbsequencing/epilepsy_lcsb/RCP/${line}/tmp*/CGIASM.seg.gz  > ${outdir}/${line}.rcp.in
    ls -1 /home/users/djambulingam/dhana/isbsequencing/epilepsy_lcsb/RCP/${line}/tmp*/CGIASM.seg.gz > ${outdir}/${line}.rcp.unZip
    sed -i 's/.gz//g' ${outdir}/${line}.rcp.unZip
done
